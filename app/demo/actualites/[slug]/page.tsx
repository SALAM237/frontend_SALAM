...
const NEWS = [
  ...
  },
  {
    ...
    content: `La bourse d'excellence SALAM 2026 est ouverte aux candidatures jusqu'au 30 juin 2026. Cette bourse, dotée de 1 000 000 F.CFA par lauréat, récompense les étudiants membres de SALAM qui se distinguent par leur excellence académique et leur engagement associatif.\n\nCritères d'éligibilité : être membre actif de SALAM depuis au moins 6 mois, être inscrit dans un établissement d'enseignement supérieur au Cameroun ou au Maroc, et justifier d'une moyenne générale supérieure à 14/20 ou équivalent.\n\nLes dossiers de candidature sont à télécharger depuis l'espace membre. Trois lauréats seront sélectionnés par la commission et annoncés lors de la cérémonie de fin d'année.`,
  },
  {
    ...
    content: `Le tournoi sportif de printemps s'est tenu le 13 avril 2026 à Yaoundé. Huit équipes représentant les antennes de Yaoundé, Douala, Bafoussam, Casablanca, Rabat et Garoua ont participé à cette journée de compétition conviviale.\n\nAprès des matchs intenses et sportifs, c'est l'équipe de l'antenne de Yaoundé qui a remporté le trophée, suivie de Casablanca en deuxième position. Le prix du fair-play a été attribué à l'équipe de Douala.\n\nAu-delà de la compétition, cette journée a été l'occasion de renforcer les liens entre membres de différentes antennes et de préparer la rentrée sportive 2026-2027. Le prochain tournoi est d'ores et déjà prévu pour l'automne.`,
  },
  {
