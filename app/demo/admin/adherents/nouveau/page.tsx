...
const ANTENNES = ['Yaounde', 'Douala', 'Bafoussam', 'Garoua', 'Maroua', 'Casablanca', 'Rabat', 'Autre'];
...
export default function DemoAdminNewMemberPage() {
  ...
  const [form, setForm] = useState({
    ...
    city: '', country: 'Cameroun', role: 'Membre actif', antenne: 'Yaounde', motivation: '',
    promotionYear: '',
  });
