...
import { Gift, X, Search, Image as ImageIcon, Loader2, Send, Users, CheckSquare, Square, Calendar, Package } from 'lucide-react';
import { useAdminCampaigns, useCreateCampaign, useUploadCampaignImage, type CampaignDoc } from '@/lib/api/marketing';
