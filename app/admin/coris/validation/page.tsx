  ...
  return (
    <div className="overflow-hidden rounded-lg border border-neutral-200 bg-white shadow-sm">
      <div className="bg-emerald-950 p-6 text-white">
        ...
        <h1 className="mt-3 text-xl font-black">Validation des caurris</h1>
      ...
      <div className="space-y-5 p-6">
        ...
        <div className="rounded-lg bg-amber-50 p-5 text-center">
          ...
          <p className="text-xs font-bold uppercase text-amber-700">caurris a utiliser</p>
        </div>
        ...
        {redeem.isSuccess ? (
          <div className="flex items-center justify-center gap-2 rounded-lg bg-emerald-50 p-4 font-bold text-emerald-700"><CheckCircle2 size={20} /> caurris valides</div>
        ) : (
