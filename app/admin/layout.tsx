...
const BASE_NAV: NavItem[] = [
  { label: 'Tableau de bord',   href: '/admin/dashboard',         icon: LayoutDashboard, permissions: ['members.read'] },
  { label: 'Adhérents',         href: '/admin/adherents',         icon: Users, permissions: ['members.read', 'adhesions.read'] },
  { label: "Frais d'adhésion",  href: '/admin/cotisations',       icon: Banknote, hidden: true },
  { label: 'Facturation',       href: '/admin/facturation',       icon: FileText, permissions: ['invoices.read'] },
  ...
  { label: 'Activités',         href: '/admin/activites',         icon: CalendarDays, permissions: ['events.read'] },
  { label: 'Scanner QR',        href: '/admin/scanner',           icon: ScanLine,    permissions: ['scans.create', 'scans.read'] },
  { label: 'Galerie',           href: '/admin/galerie',           icon: Images, permissions: ['gallery.read'] },
  { label: 'Actualités',        href: '/admin/actualites',        icon: Newspaper, permissions: ['content.read', 'featured.read'] },
  ...
  { label: 'Messages',          href: '/admin/messages',          icon: MessageSquare, permissions: ['messages.read'] },
  { label: 'Assistant IA',      href: '/admin/assistant-ia',      icon: Sparkles, permissions: ['ai.use'] },
  ...
  { label: 'Bureau',            href: '/admin/bureau',            icon: Users, permissions: ['admins.read'] },
  { label: 'Compte',            href: '/admin/parametres',        icon: Settings, permissions: ['profile.read', 'settings.read'] },
];
