...
async function generateCardBlob(member: MemberCardData): Promise<Blob> {
  ...
  /* QR code */
  try {
    const qrSrc = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(`https://salam-cameroun.com/verify/${member.id}`)}&bgcolor=07140d&color=ffffff&margin=8&qzone=1`;
...
export default function MembreCartePage() {
  ...
  const handleShare = async () => {
    const url  = `https://salam-cameroun.com/verify/${memberId}`;
