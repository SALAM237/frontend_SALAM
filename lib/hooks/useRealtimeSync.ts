...
const DOMAIN_KEYS: Record<string, string[]> = {
  ...
  receipts:            ['admin-receipts', 'member-receipts', 'admin-treasury-transactions', 'member-treasury-transactions', 'admin-treasury-overview', 'member-treasury-overview'],
  cotisations:         ['admin-cotisations', 'member-cotisations', 'cotisation-logs', 'admin-treasury-overview', 'member-treasury-overview', 'admin-receipts', 'member-receipts', 'admin-treasury-transactions', 'member-treasury-transactions'],
  'cotisations-annuelles': ['admin-cotisations-annuelles', 'member-cotisations-annuelles', 'cotisation-annuelle-logs', 'admin-treasury-overview', 'member-treasury-overview', 'admin-members', 'admin-receipts', 'member-receipts', 'admin-treasury-transactions', 'member-treasury-transactions'],
