      ...
      >
        ...
        <div className="sticky top-0 h-[100svh] overflow-hidden bg-[#070f09]">
          ...
          <div className="pointer-events-none absolute right-[4%] top-[3rem] z-40 flex flex-col items-end lg:hidden">
            ...
            <Link
              href={`/missions?m=${encodeURIComponent({ "01": "preparer", "02": "insertion", "03": "solidarite", "04": "developpement" }[MISSIONS[activeIdx].num] ?? '')}`}
      ...
      {MISSIONS.map((mission, index) => {
        ...
        return (
          ...
          >
            ...
            <Link
              href={`/missions?m=${encodeURIComponent({ "01": "preparer", "02": "insertion", "03": "solidarite", "04": "developpement" }[mission.num] ?? '')}`}
