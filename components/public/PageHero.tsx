...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#07140d] via-[#0b1f15] to-[#061009] px-5 pb-[clamp(2.25rem,4.5vw,3.8rem)] pt-[clamp(4.2rem,7.5vw,6rem)] md:px-8 lg:px-12">
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <h1 className="text-[clamp(2rem,4.6vw,3.7rem)] font-black leading-[0.96] tracking-[-0.04em]">
          {renderTitle()}
        </h1>
